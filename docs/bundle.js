...
var Scheduler_1 = __webpack_require__(41);
...
const fromEvent_1 = __webpack_require__(14);
const drivers_1 = __webpack_require__(36);
...
if (cursor && recordButton && playButton && speedSelect && canvas && help) {
    ...
    const recordRequests$ = fromEvent_1.fromEvent(recordButton, 'click');
    const playRequest$ = fromEvent_1.fromEvent(playButton, 'click');
    let lastMousePosition = null;
    const speed$ = fromEvent_1.fromEvent(speedSelect, 'change')
    ...
    const actions$ = recordRequests$.mergeMap(() => {
        ...
        return drivers_1.fromUserActions()
            .shareReplay(1)
    ...
    const timeline$ = speed$.combineLatest(playRequest$)
        ...
        recordButton.style.display = 'none';
        help.style.display = 'none';
        const result$ = drivers_1.fromRecording(actions$, speed)
            .takeUntil(recordRequests$.merge(playRequest$));
        result$.subscribe({
            complete: () => {
...
Object.defineProperty(exports, "__esModule", { value: true });
const fromEvent_1 = __webpack_require__(14);
const interval_1 = __webpack_require__(37);
...
// collect clicks
function fromClicks() {
    return fromEvent_1.fromEvent(document, 'click')
        .map(({ x, y }) => ({
        time: Date.now(),
        type: 'click',
        data: { x, y }
...
exports.fromClicks = fromClicks;
// collect mousemoves
function fromMouseMoves() {
    return fromEvent_1.fromEvent(document, 'mousemove')
        .map(({ x, y }) => ({
        time: Date.now(),
        type: 'mousemove',
        data: { x, y }
...
exports.fromMouseMoves = fromMouseMoves;
function fromScroll() {
    return fromEvent_1.fromEvent(document, 'wheel')
        .map(() => {
        return {
            type: 'scroll',
            data: {
...
exports.fromScroll = fromScroll;
// collect all supported user actions
function fromUserActions() {
    return fromClicks()
...
exports.fromUserActions = fromUserActions;
// make stream that will emit actions according to their time
function fromRecording(recording$, speed) {
    const end$ = new Subject_1.Subject();
    return recording$
        .take(1)
        .mergeMap(originalActions => {
        const startTime = originalActions[0].time;
        const deltaTime = Date.now() - originalActions[0].time;
        const time$ = interval_1.interval(10).map(() => startTime + ((Date.now() - deltaTime) - startTime) * speed);
...
exports.fromRecording = fromRecording;
function fromMutations() {
...
exports.fromMutations = fromMutations;
...
var IntervalObservable_1 = __webpack_require__(38);
...
var Observable_1 = __webpack_require__(0);
var scan_1 = __webpack_require__(45);
...
var Observable_1 = __webpack_require__(0);
var share_1 = __webpack_require__(47);
...
var Observable_1 = __webpack_require__(0);
var take_1 = __webpack_require__(55);
...
var async_1 = __webpack_require__(19);
var isDate_1 = __webpack_require__(61);
var Subscriber_1 = __webpack_require__(1);
...
var Observable_1 = __webpack_require__(0);
var skipUntil_1 = __webpack_require__(65);
...
var Observable_1 = __webpack_require__(0);
var shareReplay_1 = __webpack_require__(69);
...
var multicast_1 = __webpack_require__(22);
var ReplaySubject_1 = __webpack_require__(70);
/**
 * @method shareReplay
 * @owner Observable
 */
...
var QueueScheduler_1 = __webpack_require__(73);
/**
 *
 * Queue Scheduler
 *
